...
export function EditTemplateModal({ isOpen, onClose, onSubmit, template }) {
  ...
  useEffect(() => {
    if (template) {
      ...
      // Convert templateWorkouts to the format expected by selectedWorkouts
      if (template.templateWorkouts) {
        setSelectedWorkouts(
          template.templateWorkouts.map((tw) => {
  ...
  // Update workout configuration for existing workouts
...
EditTemplateModal.propTypes = {
  ...
  template: PropTypes.shape({
    ...
    templateWorkouts: PropTypes.arrayOf(
      PropTypes.shape({
